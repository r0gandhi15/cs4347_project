...
<body>
    ...
    function performSearch() {
        ...
        fetch(`search_books.php?q=${encodeURIComponent(q)}`)
            .then(res => res.json())
            .then(data => {
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <p class="text-muted">by <strong>${book.authors ?? "Unknown"}</strong></p>
                                        <p><small><strong>ISBN:</strong> ${book.isbn}</small></p>
                                        <p><small><strong>Genre:</strong> ${book.genre ?? "N/A"}</small></p>
                                        <p><small><strong>Publication Date:</strong> ${book.publication_date ?? "N/A"}</small></p>
                                    </div>
